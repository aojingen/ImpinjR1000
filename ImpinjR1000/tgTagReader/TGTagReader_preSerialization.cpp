...
TagMap beepCache;
char tagsfile[80];
char prefix_exclude[12];
int rc,n,valtime,beeptime;
int epcEncodingMode;
  ...
  char *                        av[])
{
    ...
    bzero(prefix_exclude,12);
    strcpy(prefix_exclude,"");
    epcSession=1;
    ...
    static struct option loptions[] = {
        ...
        {"prefix_exclude", required_argument, 0, 'p'},
        {"epc_session", required_argument, 0, 's'},
        {"beep_time",   required_argument, 0, 'b'}
    };
    while(1) {
        opt = getopt_long (ac, av, "vhqr:f:t:e:p:s:b:",
 ...
 **             <DurationTrigger>86400000</DurationTrigger>
 **           </AISpecStopTrigger>
...
ArmLlrpReader::addROSpec (void)
{
    ...
    pAISpecStopTrigger->setDurationTrigger(864000000);
#else
    ...
    else
    {
        //strcpy(aBuf, "---missing-epc-data---");
			...
			lastBeepT=rawtime;
                    ...
                    if(strcmp(prefix_exclude,"")!=0){
                        char* foundPrefToEx=strstr(mapKey,prefix_exclude);
                        if(foundPrefToEx!=NULL){
                            toBeep=false;
                        }
                    }
                    if(toBeep){
